...
const surveyIntentPrompt = ChatPromptTemplate.fromTemplate(`
  ...
  - system_message: jika nilai 'wants_to_start' false, parafrasekan pesan ini "Tidak masalah jika Anda belum siap untuk memulai survei. Silakan kirim pesan kapan saja jika Anda ingin memulai." dengan panjang kalimat yang sama tetapi diksi yang berbeda.'
`);
